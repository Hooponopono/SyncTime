/*
COPYRIGHT
Copyright 2012 "http://github.com/NodeGuy/ServerDate/blob/master/lib/ServerDate.js"
...
var ServerDate = (function (serverNow) {
  ...
  ServerDate.synchronizationIntervalDelay = 5 * 60 * 1000; // ms, 10 minutes
  ...
  function synchronize() {
    ...
    function requestSample() {
      ...
      request.onreadystatechange = function () {
        ...
        serverClientRequestDiffTime = responseTime - clientTimestamp;

        serverClientResponseDiffTime = responseTime - responseTime;
    ...
    function processSample(serverNow) {
      ...
      var precision = responseTime - requestTime,
        sample = new Offset(
          (serverClientRequestDiffTime -
            serverNow +
            clientTimestamp -
